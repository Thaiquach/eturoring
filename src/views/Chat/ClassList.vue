            ...
            <div v-if="selectedClassId === classItem.id" class="class-detail">
              ...
              >
                ...
                <button
                  ...
                  class="tutor-btn"
                  @click.stop="selectChat(classItem.tutorUserId, classItem.tutorName)"
                >
                  {{ classItem.tutorName }}
                </button>
              </p>
              ...
              <div class="student-list">
                <button
                  ...
                  :key="index"
                  v-if="classItem.studentUserIds[index] !== currentUserId"
                  class="student-item"
                  @click.stop="selectChat(classItem.studentUserIds[index], stuName)"
                >
                  {{ stuName }}
                </button>
              </div>
